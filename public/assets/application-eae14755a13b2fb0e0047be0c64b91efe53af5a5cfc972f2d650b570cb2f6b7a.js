...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Override.form.Panel": [],
  "TMC.controller.Configuration": [],
  "TMC.controller.Data": [],
  "TMC.controller.Map": [],
  "TMC.controller.Profile": [],
  "TMC.controller.Technician": [],
  "TMC.model.ApiVersion": [],
  "TMC.model.BoolResponse": [],
  "TMC.model.ClockingHistory": [],
  "TMC.model.DatabaseEnvironment": [],
  "TMC.model.DefaultConfiguration": [],
  "TMC.model.Job": [],
  "TMC.model.Job2": [],
  "TMC.model.LocalConfig": [],
  "TMC.model.LocationHistory": [],
  "TMC.model.RepairOrder": [],
  "TMC.model.TMCUser": [],
  "TMC.model.TechInfo": [],
  "TMC.model.Technician": [],
  "TMC.override.plugin.ListPaging": [],
  "TMC.override.plugin.PullRefresh": [],
  "TMC.store.APIVersionStore": [],
  "TMC.store.AttendanceClockingStore": [],
  "TMC.store.DatabaseEnvironmentStore": [],
  "TMC.store.DefaultConfigurationStore": [],
  "TMC.store.JobStore": [],
  "TMC.store.LabourClockingStore": [],
  "TMC.store.LocalConfigStore": [],
  "TMC.store.LocationHistoryStore": [],
  "TMC.store.RepairOrderStore": [],
  "TMC.store.SalespersonStore": [],
  "TMC.store.TMCUserStore": [],
  "TMC.store.TechInfoStore": [],
  "TMC.store.TechnicianStore": [],
  "TMC.store.ValidateUserStore": [],
  "TMC.view.Main": [],
  "TMC.view.PanelConfig": [],
  "TMC.view.PanelLogin": [],
  "TMC.view.PanelProfile": []
});
